...
int main() {
    ...
    // Tanishk and chauhan subscribe to Exposed channel
    channel->subscribe(subs1);
    channel->subscribe(subs2);

    // Upload a video: both Tanishk and chauhan are notified
    channel->uploadVideo("Observer Pattern Tutorial");

    // Tanishk unsubscribes; chauhan remains subscribed
    channel->unsubscribe(subs1);

    // Upload another video: only chauhan is notified
